...
INSERT INTO dbProj_books (creator_id, title, author_name, short_description, image_url, media_url, publish_date) 
VALUES (2, 'The Mystery of the Old Manor', 'Arthur Conan Doyle', 'A thrilling detective story set in Victorian England.', NULL, NULL, '2023-01-15 10:00:00');

INSERT INTO dbProj_books (creator_id, title, author_name, short_description, image_url, media_url, publish_date) 
VALUES (2, 'Data Structures and Algorithms', 'Robert Lafore', 'A comprehensive guide to understanding foundational computer science concepts.', NULL, NULL, '2021-06-20 09:30:00');

INSERT INTO dbProj_books (creator_id, title, author_name, short_description, image_url, media_url, publish_date) 
VALUES (3, 'The Culinary Art of Pastry', 'Julia Child', 'Mastering the fine techniques of French baking and pastry creation.', NULL, NULL, '2025-11-05 14:00:00');

INSERT INTO dbProj_books (creator_id, title, author_name, short_description, image_url, media_url, publish_date) 
VALUES (3, 'Journey to the Stars', 'Carl Sagan', 'An exploration of space, time, and cosmic evolution.', NULL, NULL, '2022-08-12 18:45:00');
